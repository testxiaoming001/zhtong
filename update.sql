...
-------码商押金浮动金额
ALTER TABLE `www_zf_com`.`cm_ms`
ADD COLUMN `deposit_floating_money` decimal(8, 2) NOT NULL COMMENT '码商押金浮动金额' AFTER `is_open_mch_paycodes`



------新增提现方式字段
ALTER TABLE  `cm_balance_cash`
ADD COLUMN `type` tinyint(1) NOT NULL DEFAULT 0 COMMENT '提现方式  0:银行卡  1:usdt' AFTER `cash_file`
