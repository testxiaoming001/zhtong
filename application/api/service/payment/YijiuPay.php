...
class YijiuPay extends ApiPayment
{
    /**
     * 统一下单
     */
    private function pay($order,$type='932'){
        ...
        $Md5key = "e312e74ba6734ec68aaf1cbfe8a1add4";   //密钥
        $tjurl = "http://pay.yijuopay.com/api.aspx?";   //提交地址
...
$md5str = substr($md5str , 0, -1). $Md5key;
        ...
        $native['pay_version'] = "vb1.0";
        $native['pay_applydate'] = $pay_applydate;
//var_dump($native);die();
