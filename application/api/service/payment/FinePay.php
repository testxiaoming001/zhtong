...
class FinePay extends ApiPayment
{
    /**
     * 统一下单
     */
    private function pay($order,$type='支付宝转卡'){


        $url = 'http://cqzftd.com/pay';
        $merkey ='ace168f957c248df9f853e76cef0f2a1';

        $data = [
            //'mchId' =>  '39673',
            'AppId' =>  'c50a8ae8e637429ebf8cdec7da3cd3e7',
            'PayType' =>  $type,
...
//        var_dump($url);die();
    ...
    {
        $notifyData =$_POST;
        Log::notice("FinenPay notify data1".json_encode($notifyData));

 echo "success";
                $data['out_trade_no'] = $notifyData['Sn'];
                return $data;
