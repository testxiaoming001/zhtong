 ...
 */
class WdPay extends ApiPayment
{
    ...
    {
        $Md5key = "uenbnlpimbvv3spftqkk8s5g7qi10yq1";
        ksort($native);
        $md5str = "";
    ...
    */
    ...
    {
        $pay_memberid = "10092";   //商户后台API管理获取
        ...
        $native['request_post_url'] ="http://pay.payweidu.com/Pay_index.html";
