 ...
 */
class AaPay extends ApiPayment
{
    /*
    *  统一下单
    *
    */
    private  function getPayUnifiedOrder($order, $pay_bankcode="914")
    {
        $pay_memberid = "10013";   //商户ID
        ...
        $Md5key = "nz9r0uak6wbmodi021rho3nbwit57omh";     //密钥
        ...
        $native['request_post_url'] ="http://121.127.226.40:82//Pay_Index.html";
    ...
    public function notify()
    {
        ...
        $md5key = "nz9r0uak6wbmodi021rho3nbwit57omh";
        ksort($returnArray);
        reset($returnArray);
        $md5str = "";
