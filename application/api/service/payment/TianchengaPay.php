...
class TianchengaPay extends ApiPayment
{
    /**
     * 统一下单
     */
    private function pay($order,$type='3'){
        $url = 'https://aaa.nsebuy.com/?c=Pay';

        $mch_key = 'db325893d72431c2aa904fa5b4dd11de95ad5969';
        $p_data=array(
            'time'=>time(),
            'mch_id'=>'万通一号',
            'ptype'=>$type,
    ...
    public function query($notifyData){
        ...
        $url = 'https://www.rhzjxrr.cn/?c=Pay&a=query';

        $mch_key = '6c34d8577beb532b2a323df77364b8b57d9c33da';
        $p_data=array(
            'time'=>time(),
            'mch_id'=>'baibai01',
