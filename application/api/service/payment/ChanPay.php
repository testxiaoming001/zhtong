...
class ChanPay extends ApiPayment
{
    /**
     * 统一下单
     */
    private function pay($order,$type='903'){
        ...
        $Md5key = "tfq1v8suos1f4f8imwhnhwkleaace9rg";   //密钥
        $tjurl = "http://45.62.126.190/Pay_Index.html";   //提交地址
    ...
    public function query($notifyData){
        $url = 'http://45.62.126.190/Pay_Trade_query.html';

        $Md5key = 'tfq1v8suos1f4f8imwhnhwkleaace9rg';
        $native=array(
            'pay_memberid'=>'10194',
