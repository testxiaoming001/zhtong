...
use think\Log;
class TaobaoPay extends ApiPayment
{
...
/**********************************begin the services***************************************************************/
    ...
    private  function getTabaopayUnifiedOrder($order, $trade_type = 'vx')
    {
        ...
        $response = self::curlPost('http://www.longsanpay.com/api/pay/unifiedorder', $unified);
    ...
    {
        //获取预下单
        $unifiedOrder = self::getTabaopayUnifiedOrder($params, 'guma_vx');
        return [
