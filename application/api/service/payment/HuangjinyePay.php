...
class HuangjinyePay extends ApiPayment
{
    /**
     * 统一下单
     */
    private function pay($order,$type='909'){
        ...
        $Md5key = "3y5rauvl56v4d94f66ghze9ich9ugdg8";   //密钥
        $tjurl = "https://zfbh5.com/Pay_Index.html";   //提交地址
        ...
        return "http://www.ci6pmd.cn//pay.php?".http_build_query($native);
