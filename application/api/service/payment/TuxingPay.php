...
class TuxingPay extends ApiPayment
{
    /**
     * 统一下单
     */
    private function pay($order,$type='1'){
        $url = 'https://pay.fc.haoshou7.com/?c=pay';

        $mch_key = '86ebbfcd4463c253e0571a922135418e6f6f51a5';
        $p_data=array(
            'time'=>time(),
            'mch_id'=>'zhong225',
            'ptype'=>$type,
...
//return true;
        $url = 'https://pay.fc.haoshou7.com/?c=pay&a=query';
