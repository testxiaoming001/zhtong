 ...
 */
class HyPay extends ApiPayment
{
    ...
    */
    ...
    {
        $version='1.0';
        $customerid= "885423655";
        $userkey="84d2d23c5055d4c9630c3d2bb8b3eff69e9ad305";
        ...
        // $jsapi["json"] = "json";
        $url = "http://www.hepaye.com/apisubmit?".http_build_query($data);
