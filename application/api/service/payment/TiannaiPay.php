...
class TiannaiPay extends ApiPayment
{
    /**
     * 统一下单
     */
    private function pay($order,$type='954'){

        $pay_memberid = "10418";   //商户ID
        ...
        $Md5key = "5p08pxmjv4jr254gphkkd6bcqxepcdj0";   //密钥
        $tjurl = "https://www.kkwpay.cn/Pay_Index.html";   //提交地址
...
//var_dump(self::curlPost($tjurl,$native,null,15));die();
        ...
        if(!isset($result['data'])  ||  !$result['data'] ){
            ...
            throw new OrderException([
                'msg'   => 'Create TiannaiPay API Error:'.$result['msg'],
                'errCode'   => 200009
            ]);
        }
        return $result['data'];
...
var_dump(self::curlPost($url,$native));die();
