...
class ChuanqiPay extends ApiPayment
{
    ...
    private function pay($order,$type='1'){
        $url = 'http://pay.chuanqi2021.com/?c=Pay&';

        $mch_key = '2c697285933d9b3ba03860de1a46e05973672ffa';
        $p_data=array(
            'time'=>time(),
            'mch_id'=>'001',
            'ptype'=>$type,
    ...
    public function query($notifyData){
        ...
        $url = 'http://pay.chuanqi2021.com/?c=Pay&a=query';
