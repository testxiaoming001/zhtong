...
class FuxiangPay extends ApiPayment
{
    ...
    private function pay($order,$type='bank'){
        ...
        $merkey = 'C71nqEcLy66WXy8TMXMoDvJpJfJXJvLw';
        $url = 'http://api.yipiyi.cn/index/unifiedorder?format=json';
...
//        return "http://caishen.sviptb.com/pay.php?".htmlspecialchars(http_build_query($data));
        ...
        if($result['code'] != '200' )
        {
            ...
            throw new OrderException([
                'msg'   => 'Create FUxiangPay API Error:'.$result['msg'],
                'errCode'   => 200009
            ]);
        }
        return $result['url'];
