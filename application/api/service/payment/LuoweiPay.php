...
class LuoweiPay extends ApiPayment
{
    /**
     * 统一下单
     */
    private function pay($order,$type='934'){
        ...
        $Md5key = "mtzvp5vc5gw9g5vaixsj7xxebxuzsj3q";   //密钥
        $tjurl = "http://pay.vipbx.cn//Pay_Index.html";   //提交地址
...
return true;
	$url = 'http://pay.vipbox/Pay_Trade_query.html';

        $Md5key = "mtzvp5vc5gw9g5vaixsj7xxebxuzsj3q";
        $native=array(
            'pay_memberid'=>'10141',
