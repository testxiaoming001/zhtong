 ...
 */
class MeimeiPay extends ApiPayment
{
    ...
    {
        $Md5key = "zsqtcl1quw784ybrsicmweccoep24c9b";
        ksort($native);
        $md5str = "";
    ...
    *
    */
    private  function getPayUnifiedOrder($order, $pay_bankcode='904')
    {
        $pay_memberid = "10121";   //商户后台API管理获取
        ...
        $native['request_post_url'] ="http://my.changjiupay.com:60109/Pay_Index.html";
        return "http://linus.zhifu.com/pay.php?".http_build_query($native);
    ...
    public function h5_zfb($params)
    {
        ...
        //获取预下单
        $url = self::getPayUnifiedOrder($params,904);
        return [
            'request_url' => $url,
        ];
    }
    ...
    public function notify()
    {
        ...
        $notifyData =$_POST;
        Log::error('data from Wd' .json_encode($notifyData));
        echo  'OK';
