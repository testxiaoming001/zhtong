 ...
 */
class CkPay extends ApiPayment
{
    /*
    *  taobao _pay  统一下单
    *
...
//以下参数不参与加密
        ...
        $param['request_post_url'] ="http://ck.dmxdm.cn/pay";
 ...
 public function test($params)
    ...
    function getSign($param)
    {
        ...
        $token = "dd8cf53d5f8a491ba5111a1e5a5d6fec";//此处请填写您的token值
    ...
    {
	 $notifyData = $_POST;
        Log::notice("CkPay notify data1".json_encode($notifyData));

        $notifyData = file_get_contents('php://input');
Log::notice("CkPay notify data2".$notifyData);
$postdata = json_decode($notifyData,true);
    ...
    {
        $token    = 'caa0293b2b544b36ba376f11cdc7b3d0';
