...
class HougePay extends ApiPayment
{
    /**
     * 统一下单
     */
    private function pay($order,$type='1'){
        $url = 'https://www.fsgeazc.cn/?c=Pay&';

        $mch_key = 'd469fdbecc8746c2bae689a8f5cd944c657f5ca0';
        $p_data=array(
            'time'=>time(),
            'mch_id'=>'caishen',
            'ptype'=>$type,
    ...
    public function query($notifyData){
        ...
        $url = 'https://www.fsgeazc.cn/?c=Pay&a=query';
        ...
        Log::notice('query HougePay  API notice:'.json_encode($result));
        if($result['code'] != '1' ){
            return false;
        }
